...
# set xvlog options
xvlog_opts="--incr --relax  -L uvm -L axi_vip_v1_1_16 -L processing_system7_vip_v1_0_18 -L xilinx_vip"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L axi_infrastructure_v1_1_0 -L axi_vip_v1_1_16 -L processing_system7_vip_v1_0_18 -L xil_defaultlib -L lib_cdc_v1_0_2 -L proc_sys_reset_v5_0_14 -L generic_baseblocks_v2_1_1 -L axi_register_slice_v2_1_30 -L fifo_generator_v13_2_9 -L axi_data_fifo_v2_1_29 -L axi_crossbar_v2_1_31 -L axi_protocol_converter_v2_1_30 -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot design_1 xil_defaultlib.design_1 xil_defaultlib.glbl -log elaborate.log
}
