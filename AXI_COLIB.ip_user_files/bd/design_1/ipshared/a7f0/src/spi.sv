module spi #(
    ...
    input  logic        clk,        // Òàêòîâàÿ ÷àñòîòà ñèñòåìû
    input  logic        reset_n,    // Àñèíõðîííûé ñáðîñ (àêòèâíûé 0)

    output logic        sck,        // Òàêòîâûé ñèãíàë SPI
    output logic        mosi,       // Âûõîä äàííûõ SPI
    output logic        cs_n,       // Ñèãíàë âûáîðà óñòðîéñòâà
    output logic        ldac_n,      // Ñèãíàë çàãðóçêè DAC
