...
-- Date        : Tue Sep 23 16:09:47 2025
-- Host        : DESKTOP-JUTT43E running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim
--               c:/Vivado_Projects/AXI_COLIB/AXI_COLIB.gen/sources_1/bd/design_1/ip/design_1_dac_lite_0_0/design_1_dac_lite_0_0_sim_netlist.vhdl
...
entity design_1_dac_lite_0_0_fifo is
  port (
  ...
  attribute ORIG_REF_NAME of design_1_dac_lite_0_0_fifo : entity is "fifo";
end design_1_dac_lite_0_0_fifo;

architecture STRUCTURE of design_1_dac_lite_0_0_fifo is
  ...
  attribute SOFT_HLUTNM of axi_wready_i_2 : label is "soft_lutpair0";
  ...
  attribute SOFT_HLUTNM of start_transmission_i_4 : label is "soft_lutpair0";
...
start_transmission_i_4: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00000001"
    )
        port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_dac_lite_0_0_spi is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of design_1_dac_lite_0_0_spi : entity is "spi";
end design_1_dac_lite_0_0_spi;

architecture STRUCTURE of design_1_dac_lite_0_0_spi is
  ...
  signal start_transmission_i_3_n_0 : STD_LOGIC;
  signal transmission_active_i_1_n_0 : STD_LOGIC;
  signal transmission_active_reg_n_0 : STD_LOGIC;
  signal \^tready\ : STD_LOGIC;
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \bit_counter[0]_i_1\ : label is "soft_lutpair12";
  ...
  attribute SOFT_HLUTNM of \bit_counter[4]_i_5\ : label is "soft_lutpair14";
  ...
  attribute SOFT_HLUTNM of \cs_counter[3]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \cs_counter[4]_i_3\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \cs_counter[4]_i_4\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of cs_n_i_2 : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of cs_n_i_3 : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of fifo_rd_en_i_1 : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of flag_sck_i_1 : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of ldac_pulse_i_1 : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \sck_counter[1]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \sck_counter[2]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of sck_int_i_3 : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \shift_reg[0]_i_1\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \shift_reg[28]_i_1\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \shift_reg[29]_i_1\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \shift_reg[30]_i_1\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \shift_reg[31]_i_1\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of start_transmission_i_1 : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of start_transmission_i_3 : label is "soft_lutpair6";
begin
  JB2 <= \^jb2\;
  JB3 <= \^jb3\;
  JB4 <= \^jb4\;
...
\cs_counter[4]_i_3\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"80"
    )
        port map (
...
\cs_counter[4]_i_4\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"7F"
    )
        port map (
...
start_transmission_i_2: unisim.vcomponents.LUT6
    generic map(
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_dac_lite_0_0_DAC_wrapper is
  port (
    s00_axi_aresetn_0 : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of design_1_dac_lite_0_0_DAC_wrapper : entity is "DAC_wrapper";
end design_1_dac_lite_0_0_DAC_wrapper;

architecture STRUCTURE of design_1_dac_lite_0_0_DAC_wrapper is
...
begin
  s00_axi_aresetn_0 <= \^s00_axi_aresetn_0\;
fifo_dac: entity work.design_1_dac_lite_0_0_fifo
     port map (
...
spi_dac: entity work.design_1_dac_lite_0_0_spi
     port map (
      JB2 => JB2,
      JB3 => JB3,
      JB4 => JB4,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_dac_lite_0_0_dac_lite_v1_0_S00_AXI is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of design_1_dac_lite_0_0_dac_lite_v1_0_S00_AXI : entity is "dac_lite_v1_0_S00_AXI";
end design_1_dac_lite_0_0_dac_lite_v1_0_S00_AXI;

architecture STRUCTURE of design_1_dac_lite_0_0_dac_lite_v1_0_S00_AXI is
...
dac: entity work.design_1_dac_lite_0_0_DAC_wrapper
     port map (
      JB2 => JB2,
      JB3 => JB3,
      JB4 => JB4,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_dac_lite_0_0_dac_lite_v1_0 is
  port (
    S_AXI_AWREADY : out STD_LOGIC;
    S_AXI_WREADY : out STD_LOGIC;
    S_AXI_ARREADY : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of design_1_dac_lite_0_0_dac_lite_v1_0 : entity is "dac_lite_v1_0";
end design_1_dac_lite_0_0_dac_lite_v1_0;

architecture STRUCTURE of design_1_dac_lite_0_0_dac_lite_v1_0 is
begin
dac_lite_v1_0_S00_AXI_inst: entity work.design_1_dac_lite_0_0_dac_lite_v1_0_S00_AXI
     port map (
      JB2 => JB2,
      JB3 => JB3,
      JB4 => JB4,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_dac_lite_0_0 is
  port (
    JB1 : out STD_LOGIC;
    JB2 : out STD_LOGIC;
    JB3 : out STD_LOGIC;
  ...
  attribute NotValidForBitStream of design_1_dac_lite_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of design_1_dac_lite_0_0 : entity is "design_1_dac_lite_0_0,dac_lite_v1_0,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of design_1_dac_lite_0_0 : entity is "yes";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of design_1_dac_lite_0_0 : entity is "dac_lite_v1_0,Vivado 2023.2.2";
end design_1_dac_lite_0_0;

architecture STRUCTURE of design_1_dac_lite_0_0 is
...
inst: entity work.design_1_dac_lite_0_0_dac_lite_v1_0
     port map (
      JB2 => JB2,
      JB3 => JB3,
      JB4 => JB4,
